...
package() {
  ...
  install -Dm644 "$startdir/updater/workflow_update.py" "$pkgdir/usr/lib/chatgpt-bin/updater/workflow_update.py"
  ...
  install -Dm644 "$startdir/updater/workflow_update.py" "$pkgdir/usr/lib/chatgpt-bin/updater/recipe/updater/workflow_update.py"
  ...
  install -Dm644 "$startdir/updater/systemd/chatgpt-bin-update-workflow.service" "$pkgdir/usr/lib/chatgpt-bin/updater/recipe/updater/systemd/chatgpt-bin-update-workflow.service"
  ...
  install -Dm644 "$startdir/updater/systemd/chatgpt-bin-update-workflow.service" "$pkgdir/usr/lib/systemd/user/chatgpt-bin-update-workflow.service"
